...
const FormDateRangePicker = () => {
  return (
    <ComponentContainerCard
      title="React Suite Date Range Picker"
      description={<p className="text-muted mb-0">A JavaScript component for choosing date ranges, dates and times.</p>}>
      <Row>
        <Col lg={6}>
          <div className="mb-3">
...
const FormDatepicker = () => {
  return (
    <ComponentContainerCard
      title="React Suite Bootstrap Datepicker"
      description={<p className="text-muted mb-0">Bootstrap-datepicker provides a flexible datepicker widget in the Bootstrap style.</p>}>
      <Row>
        <Col lg={6}>
...
const FlatpickrDate = () => {
  return (
    <ComponentContainerCard
      title="Flatpickr - Date picker"
      description={<p className="text-muted mb-0">A lightweight and powerful datetimepicker</p>}>
      <Row>
        <Col lg={6}>
          <div className="mb-3">
            <label className="form-label d-block">Basic</label>
            <CustomFlatpickr options={{ enableTime: false }} className="form-control" placeholder="Basic" />
          </div>
...
const InputMask = () => {
  return (
    <ComponentContainerCard title="Input Masks" description={<p className="text-muted mb-0">A rsuit input masks.</p>}>
      <Row>
        <Col md={6}>
          <form action="#">
            <div className="mb-3">
        ...
        <Col lg={6}>
          <div className="mb-3">
            ...
            <div className="input-group qty-icons">
              ...
              <input type="number" value={step} className="form-control" min={0} name="quantity" style={{ pointerEvents: 'none' }} readOnly />
        ...
        <Col lg={6} className="mt-3 mt-lg-0">
          <FormGroup className="position-relative">
            ...
            <FormControl
              ...
              onChange={(e) => changeHandler(e, 'textarea')}></FormControl>
            <FormControl.Feedback type="invalid" tooltip>
...
const Typeaheads = () => {
  ...
  return (
    <ComponentContainerCard
      title="Typeahead"
      description={<p className="text-muted mb-0">Typeahead.js is a fast and fully-featured autocomplete library.</p>}>
      <Row>
        <Col lg={6}>
          <div className="mb-3">
