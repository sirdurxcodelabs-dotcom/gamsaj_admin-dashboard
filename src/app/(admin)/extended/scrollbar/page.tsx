...
const DefaultScroll = () => {
  return (
    <Card>
      ...
      <SimplebarReactClient className="card-body py-0 my-3" data-simplebar style={{ maxHeight: 250 }}>
...
const RtlPosition = () => {
  return (
    <Card>
      ...
      <SimplebarReactClient className="card-body py-0 my-3" data-simplebar data-simplebar-direction="rtl" style={{ maxHeight: 250 }}>
        SimpleBar does only one thing: replace the browser&apos;s default scrollbar with a custom CSS-styled one without losing performances. Unlike
        some popular plugins, SimpleBar doesn&apos;t mimic scroll with Javascript, causing janks and strange scrolling behaviours... You keep the
        awesomeness of native scrolling...with a custom scrollbar!
        <p>
...
const ScrollSize = () => {
  return (
    <Card>
      ...
      <SimplebarReactClient className="py-0 my-3 card-body" data-simplebar data-simplebar-lg style={{ maxHeight: 250 }}>
        SimpleBar does only one thing: replace the browser&apos;s default scrollbar with a custom CSS-styled one without losing performances. Unlike
        some popular plugins, SimpleBar doesn&apos;t mimic scroll with Javascript, causing janks and strange scrolling behaviours... You keep the
        awesomeness of native scrolling...with a custom scrollbar!
        <p>
...
const ScrollColor = () => {
  return (
    <Card>
      ...
      <SimplebarReactClient className="card-body py-0 my-3" data-simplebar data-simplebar-primary style={{ maxHeight: 250 }}>
        SimpleBar does only one thing: replace the browser&apos;s default scrollbar with a custom CSS-styled one without losing performances. Unlike
        some popular plugins, SimpleBar doesn&apos;t mimic scroll with Javascript, causing janks and strange scrolling behaviours... You keep the
        awesomeness of native scrolling...with a custom scrollbar!
        <p>
