        ...
        <Col xs={12}>
          <ComponentContainerCard
            ...
            <p className="text-muted">
              Suspendisse vel quam malesuada, aliquet sem sit amet, fringilla elit. Morbi tempor tincidunt tempor. Etiam id turpis viverra, vulputate
              sapien nec, varius sem. Curabitur ullamcorper fringilla eleifend. In ut eros hendrerit est consequat posuere et at velit.
            </p>
            ...
            <p className="text-muted">
              Vestibulum auctor tincidunt semper. Phasellus ut vulputate lacus. Suspendisse ultricies mi eros, sit amet tempor nulla varius sed. Proin
              nisl nisi, feugiat quis bibendum vitae, dapibus in tellus.
            </p>
            <div className="clearfix" />
            <h1 className="display-4">Display 4</h1>
            <p className="text-muted mb-0">
              Nulla et mattis nunc. Curabitur scelerisque commodo condimentum. Mauris blandit, velit a consectetur egestas, diam arcu fermentum justo,
              eget ultrices arcu eros vel erat.
            </p>
            <div className="clearfix" />
        ...
        <Col xs={12}>
          <ComponentContainerCard
            ...
            <p className="text-muted">
              ...
              aliquet. Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio. Vivamus pretium nec odio cursus elementum. Suspendisse molestie
              ullamcorper ornare.
            </p>
            <div className="clearfix" />
      ...
      <Row>
        <Col xl={12}>
          <ComponentContainerCard
            ...
            description={<p className="text-muted mb-0">Styling for common inline HTML5 elements.</p>}>
        ...
        <Col xl={12}>
          <ComponentContainerCard title="Contextual Text Colors" description={<p className="text-muted mb-0">Available color variations.</p>}>
            ...
            <p className="text-pink">Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
            <p className="text-purple">Duis mollis, est non commodo luctus, nisi erat porttitor ligula.</p>
            ...
            <p className="text-white-50 bg-dark mb-0">Duis mollis, est non commodo luctus, nisi erat porttitor ligula.</p>
          </ComponentContainerCard>
        </Col>
      </Row>
      <Row>
        <Col xl={4}>
          <ComponentContainerCard
            title="Unordered"
            description={<p className="text-muted mb-0">A list of items in which the order does not explicitly matter.</p>}>
            <ul>
        ...
        <Col xl={4}>
          <ComponentContainerCard
            title="Ordered"
            description={<p className="text-muted mb-0">A list of items in which the order does explicitly matter.</p>}>
            <ol>
              <li>Lorem ipsum dolor sit amet</li>
              <li>Consectetur adipiscing elit</li>
              <li>Integer molestie lorem at massa</li>
      ...
      <Row>
        ...
        <Col xl={12}>
          <ComponentContainerCard
            ...
            description={
              <p className="text-muted mb-0">
                Align terms and descriptions horizontally by using our grid system’s predefined classes (or semantic mixins). For longer terms, you
                can optionally add a <code>.text-truncate</code> class to truncate the text with an ellipsis.
              </p>
            }>
