  ...
  return (
    <div className="avatar-group">
      <OverlayTrigger overlay={<Tooltip>Tosha</Tooltip>}>
        <span role="button">
          <img src={avatar1} alt="avatar" className="rounded-circle avatar-sm" style={{ marginLeft: '-10px' }} />
        </span>
      </OverlayTrigger>
      <OverlayTrigger overlay={<Tooltip>Brain</Tooltip>}>
        <span role="button">
          <img src={avatar3} alt="avatar" className="rounded-circle avatar-sm" style={{ marginLeft: '-10px' }} />
        </span>
      </OverlayTrigger>
