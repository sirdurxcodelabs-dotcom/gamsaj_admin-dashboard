...
import { Fragment, useCallback, useEffect, useState, useMemo, type MouseEvent } from 'react'
...
const AppMenu = ({ menuItems }: AppMenuProps) => {
  ...
  const filterMenuByPermissions = useCallback((items: MenuItemType[]): MenuItemType[] => {
  ...
  }, [menuItems, filterMenuByPermissions])
