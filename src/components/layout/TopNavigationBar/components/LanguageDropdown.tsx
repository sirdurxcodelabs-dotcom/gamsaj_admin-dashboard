  ...
  return (
    <Dropdown>
      <DropdownToggle as="a" className="nav-link arrow-none" role="button" aria-haspopup="false" aria-expanded="false">
        <img src={usFlag} alt="user-image" className="me-0 me-sm-1 w-auto" height={12} />
      ...
      <DropdownMenu className="dropdown-menu-end dropdown-menu-animated">
        {languagesData.map((language, idx) => (
          <DropdownItem href="" key={idx}>
            <img src={language.flag} alt="user-image" className="me-1" height={12} /> <span className="align-middle">{language.name}</span>
          </DropdownItem>
        ))}
      </DropdownMenu>
    </Dropdown>
