  ...
  return (
    <Dropdown as="li" className="notification-list">
      ...
      <DropdownMenu className="dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                ...
                <div className="d-flex align-items-center">
                  <div className="flex-shrink-0">
                    <div className="notify-icon">
                      <img src={message.avatar} className="img-fluid rounded-circle" alt="image" />
                    </div>
                  </div>
        ...
        <Link to="" className="dropdown-item text-center text-primary text-decoration-underline fw-bold notify-item border-top border-light py-2">
          View All
        </Link>
      </DropdownMenu>
    </Dropdown>
