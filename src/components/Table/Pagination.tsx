...
const Pagination = <RowType,>({ table, rowsPerPageList, currentPage, totalPages, }: ReactTablePaginationProps<RowType>) => {
        ...
        <ul className="pagination pagination-rounded m-0">
          <li className="page-item">
            <button
              ...
              className={clsx('page-link', { disabled: !table.getCanPreviousPage() })}>
              <IconifyIcon icon="fa-solid:chevron-left" height={8} width={8} />
            </button>
          </li>
          {visiblePages.map((page, idx) => (
            <li key={idx} className={clsx('page-item', { active: page === currentPage })}>
          ...
          <li className="page-item">
            <button
              ...
              className={clsx('page-link', { disabled: !table.getCanNextPage() })}>
